...
if __name__ == '__main__':
    ...
    # Now,  we use the implementation to represent this graph: <img
    # src='https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/CPT-Graphs-directed-weighted-ex1.svg/722px-CPT-Graphs-directed-weighted-ex1.svg.png' width='25%'/>
