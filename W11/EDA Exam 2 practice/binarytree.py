...
class Node:
    ...
    def __eq__(self, other):
        ...
        return other is not None and self.elem is other.elem
        # return other is notNone and self.elem==other.elem and self.left==other.left and self.right==other.right
